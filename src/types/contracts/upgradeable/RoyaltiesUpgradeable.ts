...
export interface RoyaltiesUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface RoyaltiesUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoyaltiesUpgradeableInterface;
