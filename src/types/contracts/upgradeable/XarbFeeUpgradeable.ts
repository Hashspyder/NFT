...
export interface XarbFeeUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface XarbFeeUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XarbFeeUpgradeableInterface;
