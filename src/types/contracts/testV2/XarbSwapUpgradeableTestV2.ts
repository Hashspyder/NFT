...
export interface XarbSwapUpgradeableTestV2Interface extends utils.Interface {
  functions: {
    ...
    "getSwapVersion()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getSwapVersion",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface XarbSwapUpgradeableTestV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XarbSwapUpgradeableTestV2Interface;
  ...
  functions: {
    ...
    getSwapVersion(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getSwapVersion(overrides?: CallOverrides): Promise<PopulatedTransaction>;
