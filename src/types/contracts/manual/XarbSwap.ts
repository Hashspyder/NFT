...
export declare namespace Listable {
...
export interface XarbSwapInterface extends utils.Interface {
  functions: {
...
export interface XarbSwap extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XarbSwapInterface;
  ...
  functions: {
    ...
    ): Promise<[Listable.SwapStructOutput]>;
